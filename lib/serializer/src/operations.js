...
let decent_encrypt_CiphertextString = new Serializer( 
    ...
    C1: decent_encrypt.prototype.DIntegerString,
    D1: decent_encrypt.prototype.DIntegerString
}
);
...
let content_submit = new Serializer( 
    ...
    key_parts: array(decent_encrypt.prototype.CiphertextString),
    expiration: time_point_sec,
    publishing_fee: asset,
    synopsis: string,
    cd: optional(decent_encrypt.prototype.CustodyData)
}
);
...
let request_to_buy = new Serializer( 
    ...
    pubKey: decent_encrypt.prototype.DIntegerString
}
);
...
let proof_of_custody = new Serializer( 
    ...
    seeder: protocol_id_type("account"),
    URI: string,
    proof: optional(decent_encrypt.prototype.CustodyProof)
}
);

let decent_encrypt_DeliveryProofString = new Serializer( 
    "decent_encrypt_DeliveryProofString", {
    G1: decent_encrypt.prototype.DIntegerString,
    G2: decent_encrypt.prototype.DIntegerString,
    G3: decent_encrypt.prototype.DIntegerString,
    s: decent_encrypt.prototype.DIntegerString,
    r: decent_encrypt.prototype.DIntegerString
}
);
...
let deliver_keys = new Serializer( 
    ...
    fee: asset,
    seeder: protocol_id_type("account"),
    proof: decent_encrypt.prototype.DeliveryProofString,
    key: decent_encrypt.prototype.CiphertextString,
