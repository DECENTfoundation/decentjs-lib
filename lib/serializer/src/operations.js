...
let DIntegerString = new Serializer( 
    "DIntegerString",
    {s: string}
);

let CiphertextString = new Serializer( 
    "CiphertextString", {
    C1: DIntegerString,
    D1: DIntegerString
}
...
let CustodyData = new Serializer( 
    "CustodyData", {
    n: uint32,
...
let CustodyProof = new Serializer( 
    "CustodyProof", {
...
let DeliveryProofString = new Serializer( 
    "DeliveryProofString", {
    G1: DIntegerString,
    G2: DIntegerString,
    G3: DIntegerString,
