...
Types.int8 = {
    ...
    appendByteBuffer: function appendByteBuffer(b, object) {
        _SerializerValidation2.default.require_range(0, 0xFF, object, 'int8 ' + object);
        b.writeInt8(object);
        return;
    },
    fromObject: function fromObject(object) {
    ...
    toObject: function toObject(object) {
        ...
        _SerializerValidation2.default.require_range(MIN_SIGNED_8, MAX_SIGNED_8, object, 'uint32 ' + object);
        return parseInt(object);
    }
};
...
Types.public_key = {
    ...
    toObject: function toObject(object) {
        ...
        if (debug.use_default && object === undefined) {
            return _cjs.ChainConfig.address_prefix + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
        }
        _SerializerValidation2.default.required(object);
        return object.toString();
    },
...
Types.address = {
    ...
    toObject: function toObject(object) {
        ...
        if (debug.use_default && object === undefined) {
            return _cjs.ChainConfig.address_prefix + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
        }
